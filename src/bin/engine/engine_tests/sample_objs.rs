...
pub fn new_hero_crab() -> FreeObj<super::super::simple_custom_props::SimpleCustomProps> {
    FreeObj {
...
pub fn new_fish(dir: CoordDelta) -> FreeObj<super::super::simple_custom_props::SimpleCustomProps> {
    FreeObj {
        logical_props: LogicalProps::<simple_custom_props::SimpleCustomProps> {
            name: "Fish".to_string(),
            pass: Pass::Mov,
...
pub fn new_gawpie(dir: CoordDelta) -> FreeObj<super::super::simple_custom_props::SimpleCustomProps> {
    FreeObj {
        logical_props: LogicalProps::<simple_custom_props::SimpleCustomProps> {
...
pub fn new_floor() -> FreeObj<super::super::simple_custom_props::SimpleCustomProps> {
    FreeObj {
        logical_props: LogicalProps::<simple_custom_props::SimpleCustomProps> {
...
pub fn new_wall() -> FreeObj<super::super::simple_custom_props::SimpleCustomProps> {
    FreeObj {
        logical_props: LogicalProps::<simple_custom_props::SimpleCustomProps> {
            name: "Wall".to_string(),
            pass: Pass::Solid,
...
pub fn new_door_open() -> FreeObj<super::super::simple_custom_props::SimpleCustomProps> {
    FreeObj {
            logical_props: LogicalProps::<simple_custom_props::SimpleCustomProps> {
...
pub fn new_door_closed() -> FreeObj<super::super::simple_custom_props::SimpleCustomProps> {
    FreeObj {
            logical_props: LogicalProps::<simple_custom_props::SimpleCustomProps> {
...
pub fn new_door_win() -> FreeObj<super::super::simple_custom_props::SimpleCustomProps> {
    FreeObj {
        logical_props: LogicalProps::<simple_custom_props::SimpleCustomProps> {
            name: "Goal".to_string(),
            effect: Effect::Win,
