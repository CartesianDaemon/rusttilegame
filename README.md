...
Play a working prototype online at: <a href=https://cartesiandaemon.github.io/rusttilegame/tilegame.html>cartesiandaemon.github.io/rusttilegame/wasm/tilegame.html</a> The current version needs a keyboard to control it, and has only been tested one device, but otherwise runs successfully in a desktop browser and in a mobile browser. Press any key to start, move the hero with the arrow keys, avoid the fish, and try to reach the gold door.
